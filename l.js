...
//http://pub.alimama.com/common/code/getAuctionCode.json?auctionid=540905867057&adzoneid=91672645&siteid=25232497&scenes=1&t=1494831932336&_tb_token_=p1vA73VRKdq&pvid=10_119.129.1.189_452_1494831896059
  ...
  pl.ph = (a)=> np.Window.open("a.htm" , {always_on_top : true ,  width: 600  , height: 600} , function(l , aa , r){
       //pal= np.Window.get()
       htm.l=l
       l.y= - 30
                                    ...
                                    } ,
                                   {
                                    ...
                                    contain:  {ty:"|" ,all:[
                                                             ...
                                                             }     ,
                                                           {
                                                            pn: "100px" ,
                                                               contain:{all:[
                                                                             {html:htm("<button blue>").text("返回").click(h=>(htm.pal.x = 1,    l.x=30000 , htm.pal.show() , l.aa.html(htm.l.al =htm('<iframe nwfaketop width="100%" >').height("100%")) , l.tt.css("transform" , "") , l.jpg.attr("src" ,"lg.gif")))} ,
  ...
  pl.qq = function(lt , l){
      ...
      htm.get(fph + "QQ" , function (a , pla ){
        ...
        //l.height= 100
        l.t.text("")
        htm.pal.x = ~~((screen.availWidth - (  htm.pal.width)) / 2)
        htm.pal.y = 3
        //l.al.attr("src"   , "")
...
http://img.alicdn.com/bao/uploaded/i1/921225565/TB2ciYZXyC9MuFjSZFoXXbUzFXa_!!921225565.jpg_300x300.jpg
        ...
        */
        ...
        if(pla.length ?  r.length : ""){
             (function lhp(lp , ll , animate){
                      function q(lp , ll){
                                  if(htm(l.window).height() ? l.x==30000 : htm.pal.x = 1) return 
                              pl.ll.click()
                              gt.ft(php , "h.txt" , "l")
                              gt.ft(php    , "l.txt" , r[lp])
                              np.Shell.openItem(php + "/ph.exe")
